...
export const SERVICES = [
  ...
  { id: 2, title: 'Surgery', description: 'Advanced surgical procedures with modern operation theaters.', icon: 'Scissors', color: '#3b82f6' },
  { id: 3, title: 'Diagnostics', description: 'State-of-the-art diagnostic imaging and laboratory tests.', icon: 'Scan', color: '#7c3aed' },
  { id: 4, title: 'Pharmacy', description: 'Full-service pharmacy with a wide range of medications.', icon: 'Pill', color: '#10b981' },
